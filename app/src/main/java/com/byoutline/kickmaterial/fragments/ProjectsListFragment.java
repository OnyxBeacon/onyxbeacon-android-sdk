...
import com.byoutline.kickmaterial.adapters.CouponClickListener;
...
import com.byoutline.kickmaterial.receivers.ContentReceiver;
 ...
 */
public class ProjectsListFragment extends KickMaterialFragment implements OnyxCouponsListener, ProjectClickListener, CouponClickListener, FieldStateListener, EndlessRecyclerView.EndlessScrollListener {
    ...
    // Onyx SDK
    private OnyxBeaconManager mOnyxManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Setup OnyxBeacon SDK
        mOnyxManager = OnyxBeaconApplication.getOnyxBeaconManager(this.getActivity());
        mOnyxManager.initSDK(AuthenticationMode.CLIENT_SECRET_BASED);
        mOnyxManager.setCouponEnabled(true);
        mOnyxManager.setAPIContentEnabled(true);
    ...
    public void onResume() {
        ...
        // Setup content receiver
        if (mContentReceiver == null) {
            mContentReceiver = ContentReceiver.getInstance();
        }
        String INTENT_FILTER = this.getActivity().getPackageName() + ".content";
        this.getActivity().registerReceiver(mContentReceiver, new IntentFilter(INTENT_FILTER));
...
//        loginManager.logIn(EmailAndPass.create("g774092@trbvm.com", "g774092@trbvm.com"));
    ...
    private void setUpAdapters() {
        ...
        final boolean showHeader = sharedPreferences.getBoolean(PREFS_SHOW_HEADER, false);
        ...
        adapter = new ProjectsAdapter(getActivity(), (CouponClickListener) this, showHeader, itemViewTypeProvider);
        adapter.setCouponItems(new ArrayList<>());
...
//        projectListRv.startAnimation(AnimationUtils.loadAnimation(getActivity(), R.anim.projects_list_hide_anim));
    ...
    @Override
    public void couponClicked(int position, SharedViews views) {

    }

    @Override
    public void onCouponReceived(Coupon coupon, IBeacon iBeacon) {
        Log.d("CouponReceived", "Coupon received is " + coupon.name);
        adapter.addCouponItem(coupon);
    }
